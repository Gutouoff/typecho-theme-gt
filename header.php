...
<head>
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('style.css?v=20260807a'); ?>">
    <link rel="stylesheet" href="<?php $this->options->themeUrl('assets/css/highlight.css?v=20260807a'); ?>">
